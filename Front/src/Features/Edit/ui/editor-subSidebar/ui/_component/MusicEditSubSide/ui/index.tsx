...
export default function AudioEditSubSide() {
  ...
  return (
    <div className="p-4 space-y-4 w-full">
      ...
      >
        ...
        <p className="text-gray-300 mb-2">Drag & drop your audio file here</p>
      ...
      {state.uploadedAudios.length > 0 && (
        <div className="space-y-2">
          <h3 className="text-sm font-medium text-zinc-300">Uploaded Audios</h3>
          <div className="grid grid-cols-2 gap-2">
            {state.uploadedAudios.map((audioUrl, index) => (
