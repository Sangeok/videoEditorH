...
// const initialMoveState: AudioMoveState = {
//   isMoving: false,
//   elementId: null,
//   startX: 0,
//   originalStartTime: 0,
...
//   const [moveState, setMoveState] = useState<AudioMoveState>(initialMoveState);
...
//       e.stopPropagation();
//       const element = media.audioElement.find((el) => el.id === elementId);
//       if (!element) return;

//       startDragging(elementId, 'audio');
...
//       };
//     },
//     [media.audioElement, startDragging]
//   );

//   const updateElementPosition = useCallback(
//     (elementId: string, startTime: number, endTime: number) => {
//       updateAudioElement(elementId, {
//         startTime,
//         endTime,
